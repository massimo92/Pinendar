...
export const api = {
  ...
  addCurrentProposalGuards: (body) => request('/api/v1/proposals/current/guards', json('POST', body)),
  replaceCurrentProposalGuards: (body) => request('/api/v1/proposals/current/guards', json('PUT', body)),
  previewGuardCession: (body) => request('/api/v1/proposals/current/guard-cessions/preview', json('POST', body)),
  applyGuardCession: (body) => request('/api/v1/proposals/current/guard-cessions', json('POST', body)),
  previewGuardExchange: (body) => request('/api/v1/proposals/current/guard-exchanges/preview', json('POST', body)),
  applyGuardExchange: (body) => request('/api/v1/proposals/current/guard-exchanges', json('POST', body)),
  ...
  updateAssignment: (id, type) => request(`/api/v1/proposals/current/assignments/${encodeURIComponent(id)}`, json('PATCH', { type })),
  assignmentExchangeOptions: (id, includeFixed = false) => request(`/api/v1/proposals/current/assignments/${encodeURIComponent(id)}/exchange-options${includeFixed ? '?includeFixed=true' : ''}`),
  exchangeAssignments: (id, targetAssignmentId, confirmFixed = false) => request(`/api/v1/proposals/current/assignments/${encodeURIComponent(id)}/exchange`, json('POST', { targetAssignmentId, confirmFixed })),
  extraAssignmentOptions: (date, memberId) => request(`/api/v1/proposals/current/dates/${encodeURIComponent(date)}/members/${encodeURIComponent(memberId)}/extra-options`),
  openExtraAssignment: (date, memberId, agendaId) => request(`/api/v1/proposals/current/dates/${encodeURIComponent(date)}/members/${encodeURIComponent(memberId)}/extra-assignments`, json('POST', { agendaId })),
